...
<div style="line-height:50px;">
	<form action="book_type?method=update" method="post">
	
    <span>分类名称：</span><input type="text" name="confbooktypeup_n"  value="${hh.name}"><br>
    <span>分类描述：</span><textarea name="confbooktypeup_d" rows="3" cols="30">${hh.descroption}</textarea>
  	<input type="hidden" name="confbooktypeup_i" value=${hh.id }>
